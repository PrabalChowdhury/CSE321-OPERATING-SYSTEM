...
public class Priority_Scheduling {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            System.out.println("\nProcess" + process[i] + "--> Arrival Time=" + arrivalTime[i] + "Burst Time =" + burstTimeSolid[i] + " priority=" + priority[i] + " Completion Time=" + completeTime[i] + " Turnaround Time=" + turnAroundTime[i] + " Waiting Time=" + waitingTime[i]);
        }
