class Task02_Bonus implements Runnable{
    @Override
    public void run() {
...
public class task02_bonus{
    public static void main(String[] args){
        ...
        Thread h1 = new Thread(new Task02_Bonus(),"House Stark");
        Thread h2 = new Thread(new Task02_Bonus(),"House Targaryen");
        Thread h3 = new Thread(new Task02_Bonus(),"House Lannister");
        Thread h4 = new Thread(new Task02_Bonus(),"House Bolton");
        Thread h5 = new Thread(new Task02_Bonus(),"House Tyrell");
